...
nmap <buffer> <leader><leader>m :call GotoModuleTs({'use_custom_tsconfig': 1, 'selecting_module_str': 0})\|:set hlsearch<CR>
vmap <buffer>         <leader>m :call GotoModuleTs({'use_custom_tsconfig': 0, 'selecting_module_str': 1})\|:set hlsearch<CR>
vmap <buffer> <leader><leader>m :call GotoModuleTs({'use_custom_tsconfig': 1, 'selecting_module_str': 1})\|:set hlsearch<CR>
